...
export const Icon = ({ className, name, sizeClass = `size-5` }: { className?: string, name?: string, sizeClass?: string }): ReactNode => {
    switch (name) {
        ...
        case 'vertical-bar':
            return <svg className={`${className} ${sizeClass}`} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v14"></path></svg>;
        case 'drop':
        default:
